...
#ifndef STM32H7RSXX_HSPI_H
#define STM32H7RSXX_HSPI_H
#ifdef __cplusplus
extern "C" {
#endif
...
/** @defgroup STM32U5x9J_DISCOVERY_HSPI_RAM_Exported_Types HSPI RAM Exported Types
  * @{
  */
#define BSP_HSPI_RAM_BurstLength_t      APS256XX_BurstLength_t
#define BSP_HSPI_RAM_ReadLatencyCode_t  APS256XX_ReadLatencyCode_t
#define BSP_HSPI_RAM_WriteLatencyCode_t APS256XX_WriteLatencyCode_t

typedef enum
{
  BSP_HSPI_RAM_VARIABLE_LATENCY = 0,
  BSP_HSPI_RAM_FIXED_LATENCY    = APS256XX_MR0_LATENCY_TYPE
} BSP_HSPI_RAM_LatencyType_t;

typedef enum
{
  BSP_HSPI_RAM_LINEAR_BURST = 0,
  BSP_HSPI_RAM_HYBRID_BURST = APS256XX_MR8_BT
} BSP_HSPI_RAM_BurstType_t;

typedef enum
{
  BSP_HSPI_RAM_IO_X8_MODE  = 0,
  BSP_HSPI_RAM_IO_X16_MODE = APS256XX_MR8_X8_X16,
...
/* HSPI Burst length */
#define BSP_HSPI_RAM_BURST_16_BYTES       (BSP_HSPI_RAM_BurstLength_t)APS256XX_BURST_16_BYTES
#define BSP_HSPI_RAM_BURST_32_BYTES       (BSP_HSPI_RAM_BurstLength_t)APS256XX_BURST_32_BYTES
#define BSP_HSPI_RAM_BURST_64_BYTES       (BSP_HSPI_RAM_BurstLength_t)APS256XX_BURST_64_BYTES
#define BSP_HSPI_RAM_BURST_2K_BYTES       (BSP_HSPI_RAM_BurstLength_t)APS256XX_BURST_2K_BYTES

/* HSPI Read Latency Code */
#define BSP_HSPI_RAM_READ_LATENCY_3       (BSP_HSPI_RAM_ReadLatencyCode_t)APS256XX_READ_LATENCY_3
#define BSP_HSPI_RAM_READ_LATENCY_4       (BSP_HSPI_RAM_ReadLatencyCode_t)APS256XX_READ_LATENCY_4
#define BSP_HSPI_RAM_READ_LATENCY_5       (BSP_HSPI_RAM_ReadLatencyCode_t)APS256XX_READ_LATENCY_5
#define BSP_HSPI_RAM_READ_LATENCY_6       (BSP_HSPI_RAM_ReadLatencyCode_t)APS256XX_READ_LATENCY_6
#define BSP_HSPI_RAM_READ_LATENCY_7       (BSP_HSPI_RAM_ReadLatencyCode_t)APS256XX_READ_LATENCY_7

/* HSPI Write Latency Code */
#define BSP_HSPI_RAM_WRITE_LATENCY_3      (BSP_HSPI_RAM_WriteLatencyCode_t)APS256XX_WRITE_LATENCY_3
#define BSP_HSPI_RAM_WRITE_LATENCY_4      (BSP_HSPI_RAM_WriteLatencyCode_t)APS256XX_WRITE_LATENCY_4
#define BSP_HSPI_RAM_WRITE_LATENCY_5      (BSP_HSPI_RAM_WriteLatencyCode_t)APS256XX_WRITE_LATENCY_5
#define BSP_HSPI_RAM_WRITE_LATENCY_6      (BSP_HSPI_RAM_WriteLatencyCode_t)APS256XX_WRITE_LATENCY_6
#define BSP_HSPI_RAM_WRITE_LATENCY_7      (BSP_HSPI_RAM_WriteLatencyCode_t)APS256XX_WRITE_LATENCY_7
